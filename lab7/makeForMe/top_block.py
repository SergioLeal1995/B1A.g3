...
# Title: Top Block
# Generated: Fri Jan 31 19:08:02 2020
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Retardo_ojo_range = Range(0, Sps*2, 1, 3, 200)
        ...
        self._Retardo_bits_range = Range(0, Sps*10, 1, 5, 200)
        ...
        self._Retardo_Timing_range = Range(0, Sps-1, 1, 5, 200)
        ...
        for c in range(1, 2):
            self.menu_grid_layout_4.setColumnStretch(c, 1)
        self._No_dB_range = Range(-300, 0, 300/100., -39, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        _run_stop_0_check_box = Qt.QCheckBox('Pause')
        self._run_stop_0_choices = {True: True, False: False}
        self._run_stop_0_choices_inv = dict((v,k) for k,v in self._run_stop_0_choices.iteritems())
        self._run_stop_0_callback = lambda i: Qt.QMetaObject.invokeMethod(_run_stop_0_check_box, "setChecked", Qt.Q_ARG("bool", self._run_stop_0_choices_inv[i]))
        self._run_stop_0_callback(self.run_stop_0)
        _run_stop_0_check_box.stateChanged.connect(lambda i: self.set_run_stop_0(self._run_stop_0_choices[bool(i)]))
        self.top_grid_layout.addWidget(_run_stop_0_check_box)
        ...
        self.menu_grid_layout_1.addWidget(self._qtgui_time_sink_x_0_2_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.menu_grid_layout_1.setRowStretch(r, 1)
        for c in range(0, 1):
            self.menu_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.menu_grid_layout_3.addWidget(self._qtgui_time_sink_x_0_0_0_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
        ...
        self.menu_grid_layout_3.addWidget(self._qtgui_time_sink_x_0_0_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.menu_grid_layout_3.setRowStretch(r, 1)
        for c in range(0, 1):
            self.menu_grid_layout_3.setColumnStretch(c, 1)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/sergio/Documentos/Comu/B1A.g3/lab7/makeForMe/hipertextual-estas-son-imagenes-que-se-juegan-premio-mejor-astrofotografo-ano-2019530966.jpg', True)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/sergio/Documentos/Comu/B1A.g3/lab7/makeForMe/salida.jpg', False)
        ...
        self._Retardo_range = Range(0, 20, 1, 0, 200)
        self._Retardo_win = RangeWidget(self._Retardo_range, self.set_Retardo, 'Retardo en el canal', "counter_slider", int)
        self.top_grid_layout.addWidget(self._Retardo_win)
        ...
        # Connections
        ##################################################
        self.connect((self.E3TRadio_decisor_ff_0, 0), (self.b_bipolar_to_unipolar_ff_0, 0))
        ...
        self.connect((self.b_PCM_Encoder_Bb_0, 0), (self.blocks_char_to_float_1, 0))
        self.connect((self.b_bipolar_to_unipolar_ff_0, 0), (self.blocks_float_to_char_0, 0))
        self.connect((self.b_bipolar_to_unipolar_ff_0, 0), (self.qtgui_time_sink_x_0_2, 1))
        self.connect((self.b_unipolar2bipolar_ff_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.b_unipolar2bipolar_ff_0, 0), (self.blocks_delay_0_1_0, 0))
    ...
    def set_Rb(self, Rb):
        ...
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.Rb/8)
    ...
    def get_run_stop_0(self):
        return self.run_stop_0

    def set_run_stop_0(self, run_stop_0):
        self.run_stop_0 = run_stop_0
        self._run_stop_0_callback(self.run_stop_0)
